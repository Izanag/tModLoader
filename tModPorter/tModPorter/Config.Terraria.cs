...
public static partial class Config
{
	private static void AddTerrariaRefactors() {
		...
		RefactorStaticMember("Terraria.ID.BuffID.Sets", "BasicMountData", BuffBasicMountData());
	...
	private static void AddWorldGenToGenVars() {
		...
		static void RenameDungeonGenVar(string from, string to = null) => RenameStaticField("Terraria.WorldGen", from, to ?? from).FollowBy(OnMemberAccess("Terraria.WorldBuilding.GenVars", "CurrentDungeonGenVars"));
		static void RenameCurrentDungeonDataField(string from, string to = null) => RenameStaticField("Terraria.WorldGen", from, to ?? from).FollowBy(OnMemberAccess("Terraria.GameContent.Generation.Dungeon.DungeonCrawler", "CurrentDungeonData"));
		static ExpressionSyntax GenVarsCurrentDungeon(MemberUseRewriter rw, string memberName) => SimpleSyntaxFactory.MemberAccessExpression(SimpleSyntaxFactory.MemberAccessExpression(rw.UseType("Terraria.WorldBuilding.GenVars"), "CurrentDungeonGenVars"), memberName);
		static ExpressionSyntax CurrentDungeonData(MemberUseRewriter rw, string memberName) => SimpleSyntaxFactory.MemberAccessExpression(SimpleSyntaxFactory.MemberAccessExpression(rw.UseType("Terraria.GameContent.Generation.Dungeon.DungeonCrawler"), "CurrentDungeonData"), memberName);
		static void RefactorWorldGenVar(string name, System.Func<MemberUseRewriter, ExpressionSyntax> exprFactory) => RefactorStaticMember("Terraria.WorldBuilding.GenVars", name, ReplaceWithExpression(exprFactory));

		RefactorWorldGenVar("dungeonSide", rw => GenVarsCurrentDungeon(rw, "dungeonSide"));
		RefactorWorldGenVar("dungeonLocation", rw => GenVarsCurrentDungeon(rw, "dungeonLocation"));
		RefactorWorldGenVar("crackedType", rw => GenVarsCurrentDungeon(rw, "brickCrackedTileType"));
		RefactorWorldGenVar("dungeonX", rw => SimpleSyntaxFactory.MemberAccessExpression(rw.UseType("Terraria.WorldBuilding.GenVars"), "mainDungeonX"));
		RefactorWorldGenVar("dungeonY", rw => SimpleSyntaxFactory.MemberAccessExpression(rw.UseType("Terraria.WorldBuilding.GenVars"), "mainDungeonY"));
		RefactorWorldGenVar("lastDungeonHall", rw => CurrentDungeonData(rw, "lastDungeonHall"));
		RefactorWorldGenVar("numDRooms", rw => SimpleSyntaxFactory.MemberAccessExpression(CurrentDungeonData(rw, "dungeonRooms"), "Count"));
		RefactorWorldGenVar("numDDoors", rw => SimpleSyntaxFactory.MemberAccessExpression(CurrentDungeonData(rw, "dungeonDoorData"), "Count"));
		RefactorWorldGenVar("numDungeonPlatforms", rw => SimpleSyntaxFactory.MemberAccessExpression(CurrentDungeonData(rw, "dungeonPlatformData"), "Count"));
		RefactorWorldGenVar("dEnteranceX", rw => GenVarsCurrentDungeon(rw, "generatingDungeonTopX"));
		RefactorWorldGenVar("dxStrength1", rw => CurrentDungeonData(rw, "dungeonEntranceStrengthX"));
		RefactorWorldGenVar("dyStrength1", rw => CurrentDungeonData(rw, "dungeonEntranceStrengthY"));
		RefactorWorldGenVar("dxStrength2", rw => CurrentDungeonData(rw, "dungeonEntranceStrengthX2"));
		RefactorWorldGenVar("dyStrength2", rw => CurrentDungeonData(rw, "dungeonEntranceStrengthY2"));
		RefactorWorldGenVar("dMinX", rw => SimpleSyntaxFactory.MemberAccessExpression(CurrentDungeonData(rw, "dungeonBounds"), "Left"));
		RefactorWorldGenVar("dMaxX", rw => SimpleSyntaxFactory.MemberAccessExpression(CurrentDungeonData(rw, "dungeonBounds"), "Right"));
		RefactorWorldGenVar("dMinY", rw => SimpleSyntaxFactory.MemberAccessExpression(CurrentDungeonData(rw, "dungeonBounds"), "Top"));
		RefactorWorldGenVar("dMaxY", rw => SimpleSyntaxFactory.MemberAccessExpression(CurrentDungeonData(rw, "dungeonBounds"), "Bottom"));
		...
		RenameDungeonGenVar("dungeonSide");
		RenameDungeonGenVar("dungeonLocation");
		RenameGenVar("dungeonLake");
		RenameDungeonGenVar("crackedType", "brickCrackedTileType");
		RenameStaticField("Terraria.WorldGen", "dungeonX", "mainDungeonX", "Terraria.WorldBuilding.GenVars");
		RenameStaticField("Terraria.WorldGen", "dungeonY", "mainDungeonY", "Terraria.WorldBuilding.GenVars");
		RenameCurrentDungeonDataField("lastDungeonHall");
		RenameGenVar("maxDRooms");
		RenameStaticField("Terraria.WorldGen", "numDRooms", "dungeonRooms").FollowBy(OnMemberAccess("Terraria.GameContent.Generation.Dungeon.DungeonCrawler", "CurrentDungeonData")).FollowBy(AccessMember("Count"));
		RenameGenVar("dRoomX");
		RenameGenVar("dRoomY");
		...
		RenameGenVar("dRoomT");
		RenameGenVar("dRoomB");
		RenameStaticField("Terraria.WorldGen", "numDDoors", "dungeonDoorData").FollowBy(OnMemberAccess("Terraria.GameContent.Generation.Dungeon.DungeonCrawler", "CurrentDungeonData")).FollowBy(AccessMember("Count"));
		RenameGenVar("DDoorX");
		RenameGenVar("DDoorY");
		RenameGenVar("DDoorPos");
		RenameStaticField("Terraria.WorldGen", "numDungeonPlatforms", "dungeonPlatformData").FollowBy(OnMemberAccess("Terraria.GameContent.Generation.Dungeon.DungeonCrawler", "CurrentDungeonData")).FollowBy(AccessMember("Count"));
		RenameGenVar("dungeonPlatformX");
		RenameGenVar("dungeonPlatformY");
		RenameDungeonGenVar("dEnteranceX", "generatingDungeonTopX");
		RenameGenVar("dSurface");
		RenameCurrentDungeonDataField("dxStrength1", "dungeonEntranceStrengthX");
		RenameCurrentDungeonDataField("dyStrength1", "dungeonEntranceStrengthY");
		RenameCurrentDungeonDataField("dxStrength2", "dungeonEntranceStrengthX2");
		RenameCurrentDungeonDataField("dyStrength2", "dungeonEntranceStrengthY2");
		RenameStaticField("Terraria.WorldGen", "dMinX", "dungeonBounds").FollowBy(OnMemberAccess("Terraria.GameContent.Generation.Dungeon.DungeonCrawler", "CurrentDungeonData")).FollowBy(AccessMember("Left"));
		RenameStaticField("Terraria.WorldGen", "dMaxX", "dungeonBounds").FollowBy(OnMemberAccess("Terraria.GameContent.Generation.Dungeon.DungeonCrawler", "CurrentDungeonData")).FollowBy(AccessMember("Right"));
		RenameStaticField("Terraria.WorldGen", "dMinY", "dungeonBounds").FollowBy(OnMemberAccess("Terraria.GameContent.Generation.Dungeon.DungeonCrawler", "CurrentDungeonData")).FollowBy(AccessMember("Top"));
		RenameStaticField("Terraria.WorldGen", "dMaxY", "dungeonBounds").FollowBy(OnMemberAccess("Terraria.GameContent.Generation.Dungeon.DungeonCrawler", "CurrentDungeonData")).FollowBy(AccessMember("Bottom"));
